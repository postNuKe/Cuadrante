 ...
 *  
 *  	<es.progmac.android.others.ListPreferenceMultiSelect
...
public class ListPreferenceMultiSelect extends ListPreference {
    ...
    public static String[] parseStoredValue(CharSequence val, String separator2) {
    	String separator3;
    	if(separator2 != null) separator3 = separator2;
    	else separator3 = separator;
		if ( "".equals(val) || val == null ) {
			return null;
		}
		else {
			Log.d("parseStored", "val:" + val + " ||||||separator:" + separator3);
		
			return ((String)val).split(separator3);
		}
    }
    ...
    private void restoreCheckedEntries() {
    	...
    	String[] vals = parseStoredValue(getValue(), "\\" + separator);
